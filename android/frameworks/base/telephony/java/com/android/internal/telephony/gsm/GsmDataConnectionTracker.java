...
public final class GsmDataConnectionTracker extends DataConnectionTracker {
    ...
    public synchronized int enableApnType(String apnType) {
        ...
        //modified for supporting mms in only one pdp
        //FIXME: for use multiple pdp
        if(!Phone.APN_TYPE_DEFAULT.equals(apnType)) {
        	setEnabled(APN_DEFAULT_ID, false);
        }
        //add by alex android_team
    ...
    public synchronized int disableApnType(String type) {
        ...
        if (apnContext != null) {
            ...
            //modified for supporting mms in only one pdp
            //FIXME: for use multiple pdp
            if(!Phone.APN_TYPE_DEFAULT.equals(type) && mUserDataEnabled) {
