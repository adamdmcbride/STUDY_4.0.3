...
/*a@nufront start*/
const char *MEDIA_MIMETYPE_VIDEO_MPEG4_DIVX = "video/mpeg4-divx";
const char *MEDIA_MIMETYPE_VIDEO_MPEG4_DIVX3 = "video/mpeg4-divx3";
...
const char *MEDIA_MIMETYPE_VIDEO_VP6F = "video/vp6f";
const char *MEDIA_MIMETYPE_VIDEO_VP6A = "video/vp6a";
const char *MEDIA_MIMETYPE_VIDEO_VP8 = "video/vp8";
const char *MEDIA_MIMETYPE_VIDEO_MJPEG = "video/mjpeg";
const char *MEDIA_MIMETYPE_VIDEO_VC1 = "video/vc1";
const char *MEDIA_MIMETYPE_VIDEO_VC1_WMV3 = "video/vc1-wmv3";
const char *MEDIA_MIMETYPE_VIDEO_RV10 = "video/RV10";
const char *MEDIA_MIMETYPE_VIDEO_RV20 = "video/RV20";
const char *MEDIA_MIMETYPE_VIDEO_RV30 = "video/RV30";
const char *MEDIA_MIMETYPE_VIDEO_RV40 = "video/RV40";
const char *MEDIA_MIMETYPE_AUDIO_NUAUDIO  = "audio/nuaudio";
/*a@nufront end*/
...
/*a@nufront start*/
const char *MEDIA_MIMETYPE_CONTAINER_FFMPEG = "demux/ffmpeg";
/*a@nufront-end*/
