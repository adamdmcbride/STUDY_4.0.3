...
public class DevelopmentSettings extends PreferenceFragment
    ...
    private static final String CPU_PERFORMANCE_KEY = "cpu_performance";
    ...
    private ListPreference mCpuPerformance;
    ...
    private LivallIO.CPU mCpu = LivallIO.getCPUInstance();
    ...
    public void onCreate(Bundle icicle) {
        ...
        mCpuPerformance = (ListPreference) findPreference(CPU_PERFORMANCE_KEY);
        mCpuPerformance.setOnPreferenceChangeListener(this);
    ...
    private void updateCpuPerformanceOptions() {
        int governor = mCpu.getGovernor();
        mCpuPerformance.setValueIndex(governor);
        mCpuPerformance.setSummary(mCpuPerformance.getEntries()[governor]);
        mCpuPerformance.setDialogTitle(mCpuPerformance.getEntries()[governor]);
    }

    private void writeCpuPerformanceOptions(Object newValue) {        
        int governor = Integer.parseInt(newValue.toString());
        mCpu.setGovernor(governor);
        updateCpuPerformanceOptions();
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (HDCP_CHECKING_KEY.equals(preference.getKey())) {
            ...
            return true;
        } else if(preference == mCpuPerformance) {
            writeCpuPerformanceOptions(newValue);
            return true;
        }
        return false;
    }
