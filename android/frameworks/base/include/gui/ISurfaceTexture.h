...
protected:
	...
	virtual status_t mapExternalMem(unsigned int physAddr, size_t size) = 0;
	...
	virtual status_t transformExternalMem(unsigned int srcPA, unsigned int srcW,
                                          ...
                                          unsigned int *outH, unsigned int *outFmt) = 0;
};
