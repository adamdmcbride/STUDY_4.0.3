...
public class RecoverySystem {
    ...
    //TEL@---add for misc
    private static File MISC_RECOVERY_DIR = new File("/misc");
    private static File MISC_COMMAND_FILE = new File(MISC_RECOVERY_DIR, "boot_config");
    ...
    public static void rebootWipeUserData(Context context) throws IOException {
        ...
        //TEL@---
        MISC_RECOVERY_DIR.mkdirs();  // In case we need it
        MISC_COMMAND_FILE.delete();  // In case it's not writable

        FileWriter command_misc = new FileWriter(MISC_COMMAND_FILE);
        try {
            command_misc.write("Boot system = android;");
            command_misc.write("\n");
            command_misc.write("Boot device = emmc;");
            command_misc.write("\n");
            command_misc.write("Clear data = yes;");
            command_misc.write("\n");
    ...
    public static void rebootWipeCache(Context context) throws IOException {
        ...
        try {
            ...
            command_misc.write("\n");
            command_misc.write("Clear cache = yes;");
            command_misc.write("\n");
        } finally {
            command_misc.close();
        }
