/*
 *  arch/arm/mach-ns2816/ns2816-huashan_netxeon.c
 *
...
static struct extend_i2c_device __initdata extend_i2c_devs[] = 
{
	...
	EXT_I2C_DEV(I2C_BUS_1, &ns2816_tp_goodix, NULL, IRQ_NS2816_GPIO_INTR2),
#endif
};

static void __init ns2816_huashan_netxeon_init(void)
{
	common_init();
	ddr_pm_init();
	scm_init();
...
MACHINE_START(NS2816_HUASHAN, "NUFRONT-NS2816")
	...
	.timer		= &ns2816_timer,
	.init_machine	= ns2816_huashan_netxeon_init,
MACHINE_END
