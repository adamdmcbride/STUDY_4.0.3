...
enum {
	 ...
	 */
	GRALLOC_MODULE_PERFORM_CREATE_HANDLE_FROM_BUFFER = 0x80000001,
	GRALLOC_MODULE_PERFORM_CONVERT_BUFFER            = 0x80000002,
	GRALLOC_MODULE_PERFORM_EXIT_CONVERTION_MODE      = 0x80000003,
};
