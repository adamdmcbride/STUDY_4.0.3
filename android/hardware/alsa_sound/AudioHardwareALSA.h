...
public:
    ...
    /*a@nufront start: add for audio hal of alsa merge*/
...
public:
    ...
    /*m@nufront start: modify for getInputBufferSize interface for alsa*/
    ...
    /*a@nufront start: add for imply interface*/
    size_t              getBufferSize(uint32_t sampleRate, int channelCount);
    status_t            setHpSwitch(unsigned int val);
    status_t            getHpSwitch(unsigned int & val);
    status_t            setSpeakerSwitch(unsigned int val);
    status_t            getSpeakerSwitch(unsigned int & val);
    status_t            setHDMISwitch(unsigned int val);
    status_t            getHDMISwitch(unsigned int & val);
    status_t            initControl();
    status_t            setParameters(const String8& keyValuePairs);
    /*a@nufront end*/
...
protected:
    ...
    ALSAMixer *         mMixer;
    ALSAControl*         mControl;
    alsa_device_t *     mALSADevice;
    acoustic_device_t * mAcousticDevice;

    unsigned int        mSpeakerSwitch;
    unsigned int        mHPSwitch;
    unsigned int        mHDMIAudioSwitch;
