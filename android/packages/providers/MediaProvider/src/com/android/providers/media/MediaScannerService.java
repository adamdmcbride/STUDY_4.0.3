...
public class MediaScannerService extends Service implements Runnable
{
    ...
    /* a@nufront start: to update database */
    private void updateDatebase(String directories, String volumeName) {
        // don't sleep while scanning
        mWakeLock.acquire();
        //Log.d(TAG, "JULES updatescan in MediaScannerService directories is :"+directories);

        ContentValues values = new ContentValues();
        values.put(MediaStore.MEDIA_SCANNER_VOLUME, volumeName);

        Uri uri = Uri.parse("file://" + directories);
        ...
        try {
            ...
            scanner.updateDatabase(directories, volumeName);
        } catch (Exception e) {
    ...
    private final class ServiceHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            /* a@nufront start */
            String updateDatabase = arguments.getString("updatepath");
            String scanVolumePath = arguments.getString("scanVolumePath");
            /* a@nufront end */
            try {
                if (filePath != null) {
                ...
                /* a@nufront start */
                } else if (updateDatabase != null) {
                    //Log.d(TAG, "Jules add to update database :"+updateDatabase);
                    updateDatebase(updateDatabase, MediaProvider.EXTERNAL_VOLUME);
                /* a@nufront end */
                } else {
                    ...
                    /* a@nufront start */
                        ...
                        directories = new String[] {scanVolumePath};
