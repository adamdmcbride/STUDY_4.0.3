...
#define GPIOA(x)			(8+x)		//[8-39]
#define	GPIOB(x)			(GPIOA(32)+x)	//[40-71]
#define	GPIOC(x)			(GPIOB(32)+x)	//[72-103]
#define	GPIOD(x)			(GPIOC(32)+x)	//[104-135]

//HWVersion
//extern int hwversion;
#define	HWVERSION_NW51			(1<<0)
#define	HWVERSION_800x480		(1<<1)
#define	HWVERSION_WIFI_26M		(1<<2)
#define	HWVERSION_DDR_512M		(1<<30)
#define	HWVERSION_TC103			(1<<31)
