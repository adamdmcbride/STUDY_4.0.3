...
public class FdnSetting extends PreferenceActivity
    ...
    public static final String TAG = "FDNSETTING";
                        ...
                        if (ar.exception != null) {
                            ...
                            if (ce.getCommandError() == CommandException.Error.SIM_PUK2) {
                                ...
                                resetPinChangeStateForPUK2();
                                 ...
                                 if(ar.result != null)
                                 {
                                    int[] mResult = (int[])ar.result;
                                    displayMessage(R.string.pin2_retry, mResult[0]);
                                 }
                                 else
                                 {
                                    displayMessage(R.string.pin2_invalid);
                                 }
                                //displayMessage(R.string.pin2_invalid);            //modified by alex
                            }
                        }
                ...
                case EVENT_PIN2_CHANGE_COMPLETE: {
                        ...
                        if (ar.exception != null) {
                            ...
                            if (ce.getCommandError() == CommandException.Error.SIM_PUK2) {
                                ...
                                // FdnSetting.onCancel().
                               Log.e("FDNSETTING", "------------SIM_PUK2---------");
                                if(ar.result != null)
                                {
                                   int[] mResult = (int[])ar.result;
                                   displayMessage(R.string.badPuk2, mResult[0]);
                                }
                                else
                                {
                                   displayMessage(R.string.pin2_error_requested_puk2);
                                }
                                ...
                                if (mPinChangeState == PIN_CHANGE_PUK) {
                                   ...
                                   // displayMessage(R.string.badPuk2);       //modified by alex
                                } else {
                                   if(ar.result != null)
                                    {
                                       int[] mResult = (int[])ar.result;
                                       displayMessage(R.string.pin2_error_requested, mResult[0]);
                                    }
                                    else
                                    {
                                       displayMessage(R.string.badPin2);
                                    }
                                    //displayMessage(R.string.badPin2);   //modified by alex
                                }
     ...
     * Display a toast for message, like the rest of the settings.
     */
    private final void displayMessage(int strId, int value) {
        Toast.makeText(this, String.format(getString(strId), value), Toast.LENGTH_SHORT)
            .show();
    }
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (icicle == null) {
            ...
            Log.d(TAG, "---onCreate---icicle != null" + " mSkipOldPin:" + mSkipOldPin
                  + " mPinChangeState:" + mPinChangeState + " mOldPin:" + mOldPin
                  + " mNewPin:" + mNewPin + " DialogMessage:" + icicle.getString(DIALOG_MESSAGE_KEY)
                  + " Text:" + icicle.getString(DIALOG_PIN_ENTRY_KEY));
        }
    ...
    protected void onSaveInstanceState(Bundle out) {
        ...
        Log.e(TAG, "---onSaveInstanceState---" + " mSkipOldPin:" + mSkipOldPin
              + " mPinChangeState:" + mPinChangeState + " mOldPin:" + mOldPin
              + " mNewPin:" + mNewPin + " DialogMessage:" + mButtonChangePin2.getDialogMessage().toString()
              + " Text:" + mButtonChangePin2.getText());
    }
