...
public class AirplaneModeEnabler implements Preference.OnPreferenceChangeListener {
    ...
    private void setAirplaneModeOn(boolean enabling) {
        ...
        //add by alex for open or close the power of modem when airplane mode is on or off.
        SystemProperties.set(TelephonyProperties.PROPERTY_AIRPLANE_MODE, enabling ? "on" : "off");
