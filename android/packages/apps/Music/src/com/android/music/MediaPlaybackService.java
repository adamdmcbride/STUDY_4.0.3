...
public class MediaPlaybackService extends Service {
    ...
    private String mAudioFullPath; /* a@nufront */
...
//        mRemoteControlClient.setTransportControlFlags(flags);
    ...
    public void closeExternalStorageFiles(String storagePath) {
        ...
        /* m@nufront start: Do not stop music for better user experience
         * if the song is not in the ejected storage. */
        boolean stopFlag = true;
        if (isPlaying()) {
            if (null == mAudioFullPath || mAudioFullPath.equals("")) {
                Log.e(LOGTAG, "Should not be here, fix me!");
            } else {
                if (!mAudioFullPath.startsWith(storagePath)) {
                    stopFlag = false;
                }
            }
        }
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        // BUG fix 0001153 when delete file of sdcard, music can not replay
                        /*
                        mMediaMountedCount++;
...
//            ed.apply();
    ...
    /**
     * a@nufront start: get the absolute path from database.
     * @param path current playing song path
     * @return
     */
    private String getAudioFullPath(String path) {
        String fullPath = "";
        ContentResolver resolver = getContentResolver();
        Uri uri;
        String where;
        ...
        try {
            Cursor cursor = resolver.query(uri, mCursorCols, where, selectionArgs, null);
            if (cursor != null) {
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            mPlayer.start();
            mAudioFullPath = getAudioFullPath(mFileToPlay); /* a@nufront */
