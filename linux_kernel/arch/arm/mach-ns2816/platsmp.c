/*
 *  linux/arch/arm/mach-ns2816/platsmp.c
 *
...
{
	return __io_address(NS2816_SCU_BASE);
}
...
void __cpuinit platform_secondary_init(unsigned int cpu)
{
	...
	//gic_cpu_init(0, __io_address(NS2816_GIC_CPU_BASE));
...
int __cpuinit boot_secondary(unsigned int cpu, struct task_struct *idle)
{
	 ...
	 */
	writel(CPU1_FLOW_HOTPLUG | CPU1_ON, flow);
	dsb();
...
static void __init poke_milo(void)
{
	 ...
	 * non-zero.
	 */
	__raw_writel(BSYM(virt_to_phys(ns2816_secondary_startup)),
