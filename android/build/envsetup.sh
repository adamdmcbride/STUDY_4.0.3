...
- hgrep:   Greps on all local H files.
- cogrep:  Only all local C files.
- cppgrep: Only all local CPP files.
- jgrep:   Greps on all local Java files.
- resgrep: Greps on all local res/*.xml files.
- xmlgrep: All local xml files.
- mkgrep:  All local mk files.
- mkgrep:  All local sh files.
- kmgrep:  All Makefile and Kconfig files in kernel.
...
function hgrep()
{
    find . -name .repo -prune -o -name .git -prune -o -type f \( -name '*.h' -o -name '*.hpp' -o -name '*.hxx' \) -print0 | xargs -0 grep --color -n "$@"
}

function cogrep()
{
    find . -name .repo -prune -o -name .git -prune -o -type f \( -name '*.c' \) -print0 | xargs -0 grep --color -n "$@"
}

function cppgrep()
{
    find . -name .repo -prune -o -name .git -prune -o -type f \( -name '*.cpp' \) -print0 | xargs -0 grep --color -n "$@"
}
...
function kmgrep()
{
    find . -name .repo -prune -o -name .git -prune -o -type f \( -name 'Makefile' -o -name 'Kconfig' \) -print0 | xargs -0 grep --color -n "$@"
}
