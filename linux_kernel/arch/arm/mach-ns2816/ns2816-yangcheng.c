/*
 *  arch/arm/mach-ns2816/ns2816-yangcheng.c
 *
...
static struct extend_i2c_device __initdata extend_i2c_devs[] = 
{
	...
	EXT_I2C_DEV(I2C_BUS_0, &ns2816_ls_cm3212, NULL, EXT_IRQ_NOTSPEC),
#endif
	EXT_I2C_DEV(I2C_BUS_0, &ns2816_snd_wm8960, NULL, EXT_IRQ_NOTSPEC),

#ifdef CONFIG_TOUCHSCREEN_SIS_I2C
	EXT_I2C_DEV(I2C_BUS_1, &ns2816_tp_sis, NULL, IRQ_NS2816_GPIO_INTR2),
#endif
};
...
MACHINE_START(NS2816_YANGCHENG, "NUFRONT-NS2816")
