    ...
    public void run() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
           ...
           try {
            ...
            //Livall service
            try {
                Slog.i(TAG, "Livall Service");
                livall = new LivallService(context);
                ServiceManager.addService(
                        Context.LIVALL_SERVICE, livall);
            } catch(Throwable e) {
                Slog.e(TAG, "Failure starting Livall Service", e);
            }
        }
        ...
        final LivallService livallF = livall;
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
                ...
                try {
                    if(livallF != null) livallF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making LivallService Service ready", e);
                }
            }
        });
...
public class SystemServer {
    ...
    public static void main(String[] args) {
        if (System.currentTimeMillis() < EARLIEST_SUPPORTED_TIME) {
            ...
            if (SystemProperties.getBoolean("ro.nusmart.resetclock", true)) {
