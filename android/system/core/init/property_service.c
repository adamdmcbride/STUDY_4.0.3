...
struct {
    ...
    { "dvfs.",            AID_MEDIA,    0 },//Camera hal run in mediaserver,so add dvfs priority uid to AID_MEDIA
    { "camera.",          AID_MEDIA,    0 },
    { "modem.",       AID_RADIO, AID_SYSTEM},
...
#define	PROP_PATH_CUSTOM_FIRST		"/system/custom1.prop"
#define	PROP_PATH_CUSTOM_AFTER		"/system/custom2.prop"
void start_property_service(void)
{
    int fd;

    load_properties_from_file(PROP_PATH_CUSTOM_FIRST);
    load_properties_from_file(PROP_PATH_SYSTEM_BUILD);
    load_properties_from_file(PROP_PATH_SYSTEM_DEFAULT);
    load_properties_from_file(PROP_PATH_LOCAL_OVERRIDE);
    load_properties_from_file(PROP_PATH_CUSTOM_AFTER);
    /* Read persistent properties after all default values have been loaded. */
    load_persistent_properties();
