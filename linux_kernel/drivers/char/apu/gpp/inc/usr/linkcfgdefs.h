 ...
 *
 *  @desc   Defines constants and interfaces for configuration of APUDRV.
 *
 *  @ver    0.01.00.00
 *  ============================================================================
 ...
 *              APUDRV_BOOT_MODE. Wherein DSPLink does not do power management
 *              of DSP
 ...
 *              APUDRV_BOOT_MODE. Wherein DSPLink does power management of DSP
 ...
 *              This is added to support APUDRV_NOLOAD_MODE.
 *              PROC_attach will put DSP in local reset. It will not power up
 *              the DSP.
 *              PROC_start will set entry point for DSP i.e. c_int00 and release
 *              DSP from reset
 ...
 *              This is added to support APUDRV_NOBOOT_MODE
 ...
 *  @field  DspArch_ZSP800M
 *              It indicates that the architecture is ZSP800M.
 *  ============================================================================
 */
typedef enum {
    DspArch_Unknown    = 0u,
 ...
 *  @field  doDspCtrl
 *              Indicates whether APU DRIVER should do the dsp control for
 ...
 *              Specify -1 if the cpuFreq is not to be set from GPP-side
 *  @field  endian
 ...
 *              set internally within the APUDRV driver.
 *  @field  size
 ...
 *          pool, from which buffers for use with APUDRV can be allocated
 ...
 *  @field  linkObjects
 *              APU DRIVER configuration structures.
 *  ============================================================================
 */
