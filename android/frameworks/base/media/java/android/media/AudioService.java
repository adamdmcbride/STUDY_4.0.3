    ...
    private class AudioServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_DOCK_EVENT)) {
                ...
                Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG state = "+state);
                synchronized (mConnectedDevices) {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 1 ");
                    if (microphone != 0) {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 2 ");
                        boolean isConnected =
                            mConnectedDevices.containsKey(AudioSystem.DEVICE_OUT_WIRED_HEADSET);
                        if (state == 0 && isConnected) {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 3 ");
                            AudioSystem.setDeviceConnectionState(AudioSystem.DEVICE_OUT_WIRED_HEADSET,
                                    AudioSystem.DEVICE_STATE_UNAVAILABLE,
                                    "");
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 4 ");
                            mConnectedDevices.remove(AudioSystem.DEVICE_OUT_WIRED_HEADSET);
                        } else if (state == 1 && !isConnected)  {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 5 ");
                            AudioSystem.setDeviceConnectionState(AudioSystem.DEVICE_OUT_WIRED_HEADSET,
                                    AudioSystem.DEVICE_STATE_AVAILABLE,
                                    "");
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 6 ");
                            mConnectedDevices.put(
                                    new Integer(AudioSystem.DEVICE_OUT_WIRED_HEADSET), "");
                        }
                    } else {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 7 ");
                        boolean isConnected =
                            mConnectedDevices.containsKey(AudioSystem.DEVICE_OUT_WIRED_HEADPHONE);
                        if (state == 0 && isConnected) {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 8 ");
                            AudioSystem.setDeviceConnectionState(
                                    AudioSystem.DEVICE_OUT_WIRED_HEADPHONE,
                                    AudioSystem.DEVICE_STATE_UNAVAILABLE,
                                    "");
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 9 ");
                            mConnectedDevices.remove(AudioSystem.DEVICE_OUT_WIRED_HEADPHONE);
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 10 ");
                        } else if (state == 1 && !isConnected)  {
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 11 ");
                            AudioSystem.setDeviceConnectionState(
                                    AudioSystem.DEVICE_OUT_WIRED_HEADPHONE,
                                    AudioSystem.DEVICE_STATE_AVAILABLE,
                                    "");
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 12 ");
                            mConnectedDevices.put(
                                    new Integer(AudioSystem.DEVICE_OUT_WIRED_HEADPHONE), "");
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 13 ");
                        }
                    Log.e(TAG, "zjf:get ACTION_HEADSET_PLUG pos 14 ");
                    }
                }
                ...
                Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG state = "+state);
                synchronized (mConnectedDevices) {
                    Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 1");
                    boolean isConnected =
                        mConnectedDevices.containsKey(AudioSystem.DEVICE_OUT_AUX_DIGITAL);
                    if (state == 0 && isConnected) {
                        Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 2");
                        AudioSystem.setDeviceConnectionState(AudioSystem.DEVICE_OUT_AUX_DIGITAL,
                                                             AudioSystem.DEVICE_STATE_UNAVAILABLE,
                                                             "");
                        Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 3");
                        mConnectedDevices.remove(AudioSystem.DEVICE_OUT_AUX_DIGITAL);
                        Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 4");
                    } else if (state == 1 && !isConnected)  {
                        Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 5");
                        AudioSystem.setDeviceConnectionState(AudioSystem.DEVICE_OUT_AUX_DIGITAL,
                                                             AudioSystem.DEVICE_STATE_AVAILABLE,
                                                             "");
                        Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 6");
                        mConnectedDevices.put( new Integer(AudioSystem.DEVICE_OUT_AUX_DIGITAL), "");
                        Log.e(TAG, "zjf:get ACTION_HDMI_AUDIO_PLUG pos 7");
                    }
                }
