...
#define ITEM_BACKUP_RESTORE  6
#ifdef NS2816
#define ITEM_UPDATE_EC		 7
#define ITEM_UPDATE_XLOADER	 8
#define ITEM_UPDATE_UBOOT	 9
#define ITEM_UPDATE_RECOVERY 10
#define ITEM_MOUNT_SDCARD	 11 ///aah add 20120705
#define ITEM_POWER_OFF       12
#else
#define ITEM_UPDATE_XLOADER	 7
#define ITEM_UPDATE_UBOOT	 8
#define ITEM_UPDATE_LOGO	 9
#define ITEM_MOUNT_SDCARD	 10 ///aah add 20120705
#define ITEM_POWER_OFF       11
#endif

//backup and restore sub item
#define ITEM_BR_BACKUP       0
#define ITEM_BR_RESTORE      1
#define ITEM_ADVANCE_RESTORE 2
#define ITEM_BR_GOBACK       3
