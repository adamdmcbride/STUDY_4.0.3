...
//add local timezone support by chen
import android.util.Log;
import android.app.AlarmManager;
import com.android.settings.sntp.SNTP;
...
public class DateTimeSettings extends SettingsPreferenceFragment
    ...
    public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
        if (key.equals(KEY_DATE_FORMAT)) {
            ...
            if( autoEnabled ){
                Intent intent = new Intent(getActivity(), SNTP.class);
            ...
            //add by chen for tmp, since the SNTP server not support auto timezone..
            TimeZone.setDefault(TimeZone.getTimeZone("Asia/Shanghai"));
            //Add timezone of kernel clock by chen..
            final Activity activity = getActivity();
