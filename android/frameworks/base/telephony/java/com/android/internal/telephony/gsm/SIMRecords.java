...
public class SIMRecords extends IccRecords {
    ...
    public int getDisplayRule(String plmn) {
        int rule;
        // +[bug0001494 android_team jackyyang 20120315] fix senario of "no plmn"
        if (spn == null || "".equals(spn) || spnDisplayCondition == -1) {
        // -[bug0001494 android_team jackyyang 20120315]
            ...
            case READ_SPN_3GPP:
                if (ar != null && ar.exception == null) {
                    ...
                    if (DBG) log("Load EF_SPN: " + spn
                            + " spnDisplayCondition: " + spnDisplayCondition+"     "+spn+"     "+data.length);
