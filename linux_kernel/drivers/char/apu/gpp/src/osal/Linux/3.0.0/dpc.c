 ...
 *  @file   dpc.c
 *
 *  @path   $(APUDRV)/gpp/src/osal/Linux/3.0.0/
 *
 ...
 *  @const  MAX_DPC
 *
 *  @desc   Maximum number of DPCs supported in APU Driver port to mvlinux.
 *  ============================================================================
 */
#define MAX_DPC             32
...
int
DPC_msleep ( Uint32 msecs, Bool interruptible)
{
    TRC_1ENTER ("DPC_msleep", arg) ;
