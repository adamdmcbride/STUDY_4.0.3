...
public class PanoramaActivity extends ActivityBase implements
    ...
    private static final int MSG_FIRST_TIME_INIT = 5;
    ...
    private void updateStorageHint() {
        ...
        Log.e(TAG, "=== storage hint msg: "+noStorageText+" ===");
    ...
    private void checkStorage() {
        ...
        Log.e(TAG,"===remain size: "+mPicturesRemaining+" ===");
        updateStorageHint();
    }
    ...
    public void onShutterButtonClick() {
        ...
        if (mPausing || mThreadRunning || mSurfaceTexture == null || mPicturesRemaining <= 0) return;
    ...
    protected void onPause() {
        ...
        mMainHandler.removeMessages(MSG_FIRST_TIME_INIT);
        releaseCamera();
    ...
    protected void doOnResume() {
        ...
        if (!mFirstTimeInitialized) {
           mMainHandler.sendEmptyMessage(MSG_FIRST_TIME_INIT);
        } else {
    ...
    private void startCameraPreview() {
        ...
        //clear color effect case panorama do not support color effect.
