...
inline void   NuCameraHardware::initFrontParameters()
{
    ...
    previewColorString.append(CameraParameters::PIXEL_FORMAT_YUV420SP);
    previewColorString.append(",");
    previewColorString.append(CameraParameters::PIXEL_FORMAT_YUV420P);
    previewColorString.append(",");
    previewColorString.append(CameraParameters::PIXEL_FORMAT_YUV422I);  //YUYV
...
status_t NuCameraHardware::setParameters(const CameraParameters& params)
{
    ...
    if (strcmp(new_str_preview_format, CameraParameters::PIXEL_FORMAT_YUV420SP)&&
        ...
        strcmp(new_str_preview_format, CameraParameters::PIXEL_FORMAT_RGB565)&&
        strcmp(new_str_preview_format, CameraParameters::PIXEL_FORMAT_YUV422I)
       ) {
...
{
    int count = sizeof(sCameraInfo) / sizeof(sCameraInfo[0]);
    LOGV("%s, count=%d", __func__, count);
    return count;
}
...
{
    LOGV("%s, id=%s", __func__, id);

    int cameraId = atoi(id);
   // int faceId = sCameraInfo[cameraId].facing;
