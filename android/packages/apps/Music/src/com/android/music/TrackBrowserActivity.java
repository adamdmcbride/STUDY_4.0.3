        ...
        if (mAlbumId != null) {
            ...
            if (numresults > 0) {
                ...
                if (cursor != null) {
                    ...
                    cursor.deactivate();
                    // @TEI added close to avoid "Cursor not close leak"
                    cursor.close();
                }
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(MediaPlaybackService.META_CHANGED)) {
                ...
                if (mAdapter != null) {
                    ...
                    if (c.getCount() == 0) {
                        finish();
                        // @TEI added to avoid "Cursor not close leak"
                        c.close();
                        return;
                    }
...
// @TEI maybe "Cursor not close" leak
            ...
            // @TEI added to avoid "Cursor not close" leak 
               ...
               if (mCurrentPlaylistCursor != null) {
                   try{
                       ...
                       /*
                        * if close cursor may cause AndroidRuntime Exception
                        */
                   }catch (Exception e){
                       // ignore this only print log
                       Log.w(LOGTAG, "close Cursor exception: " + e);
                   } 
               }
