...
/*m@nufront start: audio hal alsa merge*/
/*namespace android*/
...
mixerProp[][SND_PCM_STREAM_LAST+1] = {
    ...
    ALSA_PROP(AudioSystem::DEVICE_OUT_EARPIECE, "earpiece", "Earpiece", "PCM"),
    /*m@nufront end*/
    ...
    ALSA_PROP(AudioSystem::DEVICE_OUT_WIRED_HEADSET, "headset", "Headphone", "PCM"),
    /*m@nufront end*/
