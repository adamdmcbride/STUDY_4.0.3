...
public class StorageVolumePreferenceCategory extends PreferenceCategory implements
    ...
    public void init() {
        ...
        if (mAllowFormat) {
            ...
            mFormatPreference.setTitle(mResources.getString(("/mnt/usbdisk".equals(mStorageVolume.getPath()))? R.string.sd_format_usb:R.string.sd_format));
            mFormatPreference.setSummary(mResources.getString(("/mnt/usbdisk".equals(mStorageVolume.getPath()))?R.string.sd_format_summary_usb:R.string.sd_format_summary));
        }
    }
    ...
    private void updatePreferencesFromState() {
        ...
        if(mStorageVolume != null){
            StorageDirectory= mStorageVolume.getPath();
        }else{
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            mMountTogglePreference.setTitle(mResources.getString(("/mnt/usbdisk".equals(StorageDirectory))? R.string.sd_eject_usb:R.string.sd_eject));
            mMountTogglePreference.setSummary(mResources.getString(("/mnt/usbdisk".equals(StorageDirectory))?R.string.sd_eject_summary_usb:R.string.sd_eject_summary));

        } else {
            if (Environment.MEDIA_UNMOUNTED.equals(state) || Environment.MEDIA_NOFS.equals(state)
                    || Environment.MEDIA_UNMOUNTABLE.equals(state)) {
                mMountTogglePreference.setEnabled(true);
                mMountTogglePreference.setTitle(mResources.getString(("/mnt/usbdisk".equals(StorageDirectory))?R.string.sd_mount_usb:R.string.sd_mount));
                mMountTogglePreference.setSummary(mResources.getString(R.string.sd_mount_summary));
            } else {
                mMountTogglePreference.setEnabled(false);
                mMountTogglePreference.setTitle(mResources.getString(("/mnt/usbdisk".equals(StorageDirectory))?R.string.sd_mount_usb:R.string.sd_mount));
                mMountTogglePreference.setSummary(mResources.getString(("/mnt/usbdisk".equals(StorageDirectory))?R.string.sd_insert_summary_usb:R.string.sd_insert_summary));
            }
    ...
    public Intent intentForClick(Preference preference) {
        ...
        } else if ((preference.getTitle() != null) && (preference.getTitle().toString().equals(mPreferences[APPLICATIONS].getTitle().toString()))) {
