...
/***********************************************/
    static bool isWireHeadsetDevice(audio_devices device) {
        return audio_is_wire_headset_device((audio_devices_t)device);
    }

    static bool isHDMIAudioDevice(audio_devices device) {
        return audio_is_hdmi_audio_device((audio_devices_t)device);
    }
/***********************************************/
