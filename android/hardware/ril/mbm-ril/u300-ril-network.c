...
int getSignalStrength(RIL_SignalStrength_v6 *signalStrength){
    ...
    /* +[bug0001549 android_team jackyyang 20120315] signal not correct */
    signalStrength->LTE_SignalStrength.signalStrength = -0x1;
    signalStrength->LTE_SignalStrength.rsrp = -0x1;
    signalStrength->LTE_SignalStrength.rsrq = -0x1;
    signalStrength->LTE_SignalStrength.rssnr = -0x1;
    signalStrength->LTE_SignalStrength.cqi = -0x1;
    /* -[bug0001549 android_team jackyyang 20120315] */
