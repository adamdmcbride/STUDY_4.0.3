 ...
 *
 *  @arg    linkCfg
 *             Pointer to the configuration information structure for APU DRIVER.
 ...
 *              General failure.
 *
 *  @enter  All APU Driver operations are complete.
 *
 *  @leave  None
 *
 *  @see    PROC_setup
 ...
 *
 *  @enter  procId must be valid.
 *          All APU Driver operations are complete.
 *
 *  @leave  None
 *
 *  @see    PROC_attach
...
/** ============================================================================
 *  @func   PROC_forceReset
 *
 *  @desc   Force reset the DSP device and driver.
 *
 *  @arg    None.
 *
 *  @modif  None
