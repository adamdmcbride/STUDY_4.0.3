...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void setInitialDisplaySize(int width, int height) {
		...
		Log.i("zhoukl", "-----setInitialDisplaySize()------shortSizeDp=" + shortSizeDp 
    ...
    public int rotationForOrientationLw(int orientation, int lastRotation) {
        ...
        synchronized (mLock) {
            ...
            if(mDefRotation == -1) {
                final String landscape = SystemProperties.get("ro.livall.defrotation");
                if(landscape.equalsIgnoreCase("landscape"))
                    mDefRotation = mLandscapeRotation;
                else if(landscape.equalsIgnoreCase("portrait"))
                    mDefRotation = mPortraitRotation;
                else
                    mDefRotation = Surface.ROTATION_90;
                Log.i(TAG, "landscape=" + landscape + ", mDefRotation=" + mDefRotation + ", mLandscapeRotation=" + mLandscapeRotation + ", mPortraitRotation=" + mPortraitRotation);
            }
            if (sensorRotation < 0) {
                sensorRotation = lastRotation;
                if(sensorRotation < 0) sensorRotation = mDefRotation;
            }
