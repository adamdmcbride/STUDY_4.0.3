 ...
 *          APU DRIVER and any Algorithm Framework built on top of LINK.
 *
 *  @ver    0.01.00.00
 *  ============================================================================
...
/* The APUDRV driver has already been setup by some other
 * application/process.
 */
#define DSP_SALREADYSETUP           (DSP_SBASE + 0x7l)

/* The APUDRV driver has been finalized. */
...
/* The APUDRV driver has not been set up. */
...
/* The APUDRV driver is already setup in this process. */
