...
private:
	...
	int dispatchMapExternalMem(va_list args);
    int dispatchTransformExternalMem(va_list args);
...
protected:
	...
	virtual int mapExternalMem(GraphicExternalMemInfo *param);
    virtual int transformExternalMem(TransformExternalMemInfo *param);
