...
public class MediaFile {
    ...
    public static final int FILE_TYPE_AC3     = 301;
    public static final int FILE_TYPE_NUAUDIO = 302;
    public static final int FILE_TYPE_MP2     = 303;
    public static final int FILE_TYPE_APE     = 304;
    ...
    public static final int FILE_TYPE_REAL    = 202;
    public static final int FILE_TYPE_DIVX    = 203;
    public static final int FILE_TYPE_VP8     = 204;
    public static final int FILE_TYPE_RAW     = 205;
    ...
    static {
        ...
        /* a@nufront start */
        addFileType("MP3", FILE_TYPE_NUAUDIO, "audio/nuaudio");
        addFileType("MP2", FILE_TYPE_MP2, "audio/mpeg");
        addFileType("VP8", FILE_TYPE_VP8, "video/x-vnd.on2.vp8");
        addFileType("VP8", FILE_TYPE_VP8, "video/vp6");
        addFileType("VP8", FILE_TYPE_VP8, "video/vp6f");
        addFileType("VP8", FILE_TYPE_VP8, "video/vp6a");
        addFileType("VP8", FILE_TYPE_VP8, "video/vp8");
        /* a@nufront end */
        if (isWMAEnabled()) {
        ...
        /* m@nfuront start */
        addFileType("TS", FILE_TYPE_MP2TS, "video/avc");
        addFileType("AC3", FILE_TYPE_AC3, "audio/ac3", MtpConstants.FORMAT_AC3);
        ...
        addFileType("FLV", FILE_TYPE_FLV,  "video/flv1");
        addFileType("DIVX", FILE_TYPE_DIVX, "video/mpeg4-divx", MtpConstants.FORMAT_MPEG);
        addFileType("DIVX", FILE_TYPE_DIVX, "video/mpeg4-divx3", MtpConstants.FORMAT_MPEG);
        addFileType("MOV", FILE_TYPE_MOV, "video/quicktime");
        addFileType("WMV", FILE_TYPE_WMV, "video/x-ms-wmv");
        addFileType("WMV", FILE_TYPE_WMV, "video/vc1-wmv3");
        addFileType("AVI", FILE_TYPE_AVI, "video/vc1");
        addFileType("ASF", FILE_TYPE_ASF, "video/x-ms-asf");
        addFileType("MPEG", FILE_TYPE_MP4, "video/mp4v-es");
        addFileType("MPEG", FILE_TYPE_MP4, "video/mjpeg");
        addFileType("MPEG", FILE_TYPE_MP4, "video/mpeg2");
        addFileType("MPEG", FILE_TYPE_MP4, "video/mpeg1");
        addFileType("RAW", FILE_TYPE_RAW, "video/raw");
        addFileType("RM",  FILE_TYPE_REAL, "video/vnd.rn-realvideo");
        addFileType("RMVB",FILE_TYPE_REAL, "video/vnd.rn-realvideo");
        addFileType("RMVB",FILE_TYPE_REAL, "video/RV10");
        addFileType("RMVB",FILE_TYPE_REAL, "video/RV20");
        addFileType("RMVB",FILE_TYPE_REAL, "video/RV30");
        addFileType("RMVB",FILE_TYPE_REAL, "video/RV40");
        /* m@nufront end */
