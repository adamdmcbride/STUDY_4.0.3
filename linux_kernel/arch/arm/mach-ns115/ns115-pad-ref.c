...
static struct ns115_mmc_platform_data nusmart_sdmmc_data = {
	.host_max_freq 		= 50000000,
	.nr_slots 		= 3,
	.gpio			= 57,
	.detect_delay_ms	= 800, 	/* XXX */
...
static struct platform_device ns115_plat_lcd_lvds = {
        .id = -1,
        .name = "twx",
};
#endif
...
#endif
#ifdef CONFIG_LCD_LVDS
        SOC_PLAT_DEV(&ns115_plat_lcd_lvds,NULL),
#endif
...
static struct extend_i2c_device __initdata extend_i2c_devs[] = 
{
	...
	EXT_I2C_DEV(I2C_BUS_3, &ns115_tp_ft5x0x, NULL, \
			IRQ_NS115_GPIO1_INTR6, USE_DEFAULT),
#endif
#ifdef CONFIG_MFD_AXP173
	EXT_I2C_DEV(I2C_BUS_2, &axp173_i2c_dev, NULL, \
			EXT_IRQ_NOTSPEC, USE_DEFAULT),
#endif
#ifdef CONFIG_LCD_LVDS
	EXT_I2C_DEV(I2C_BUS_3, &ns115_lcd_lvds_bl, NULL, \
			EXT_IRQ_NOTSPEC, USE_DEFAULT),
	EXT_I2C_DEV(I2C_BUS_3, &ns115_lcd_lvds,NULL, \
			EXT_IRQ_NOTSPEC, USE_DEFAULT),
#endif
};
...
struct gpio_data __initdata ref_data = {
	.gpio_ddr = {BIT(0) | BIT(4) | BIT(5),BIT(19),BIT(21) | BIT(30),0x0,0x0},
};
