...
//@TEI restore for mtp and ptp
    ...
    public Dialog onCreateDialog(int id) {
        ...
        case DLG_CONFIRM_UNMOUNT:
                return new AlertDialog.Builder(getActivity())
                    .setTitle(("/mnt/usbdisk".equals(mClickedMountPoint))?R.string.dlg_confirm_unmount_title_usb:R.string.dlg_confirm_unmount_title)
                    .setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            doUnmount();
                        }})
                    .setNegativeButton(R.string.cancel, null)
                    .setMessage(("/mnt/usbdisk".equals(mClickedMountPoint))?R.string.dlg_confirm_unmount_text_usb:R.string.dlg_confirm_unmount_text)
                    .create();
        case DLG_ERROR_UNMOUNT:
                return new AlertDialog.Builder(getActivity())
            .setTitle(R.string.dlg_error_unmount_title)
            .setNeutralButton(R.string.dlg_ok, null)
            .setMessage(("/mnt/usbdisk".equals(mClickedMountPoint))?R.string.dlg_error_unmount_text_usb:R.string.dlg_error_unmount_text)
            .create();
        }
        return null;
    }
    ...
    private void doUnmount() {
        ...
        if("/mnt/usbdisk".equals(mClickedMountPoint)) {
            Toast.makeText(getActivity(), R.string.unmount_inform_text_usb, Toast.LENGTH_SHORT).show();
        }else{
