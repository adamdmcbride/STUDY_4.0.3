...
public class StorageManager
{
    ...
    /* a@nufront start: Returns list of paths for all effective mount volumes */
    /**
     * Returns list of paths for all mountable volumes.
     * @hide
     */
    public String[] getEffectiveVolumePaths() {
        StorageVolume[] volumes = getVolumeList();
        if (volumes == null) {
            return null;
        }
