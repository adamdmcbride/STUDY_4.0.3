...
#endif
#ifdef CONFIG_FB_HDMI_CH7033
	EXT_I2C_DEV(I2C_BUS_0, &ns2816_hdmi_7033, NULL, EXT_IRQ_NOTSPEC),
	EXT_I2C_DEV(I2C_BUS_0, &ns2816_hdmi_7033_audio, NULL, EXT_IRQ_NOTSPEC),
#endif
#ifdef CONFIG_SND_SOC_WM8960
        EXT_I2C_DEV(I2C_BUS_0, &ns2816_snd_wm8960, NULL, EXT_IRQ_NOTSPEC),
#endif

#ifdef CONFIG_SENSORS_KXUD9
        EXT_I2C_DEV(I2C_BUS_0, &ns2816_gs_kxud9, NULL, EXT_IRQ_NOTSPEC),
#endif

#ifdef CONFIG_TOUCHSCREEN_ZT2083_TS 
	EXT_I2C_DEV(I2C_BUS_1, &ns2816_tp_zt2083, NULL, IRQ_NS2816_GPIO_INTR2),
#endif

#ifdef CONFIG_TOUCHSCREEN_ILITEK
	EXT_I2C_DEV(I2C_BUS_1, &ns2816_tp_ilitek, NULL, IRQ_NS2816_GPIO_INTR2),
#endif
};
