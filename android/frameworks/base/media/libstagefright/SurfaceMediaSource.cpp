...
status_t SurfaceMediaSource::mapExternalMem(unsigned int physAddr, size_t size)
{
	LOGE("SurfaceMediaSource::mapExternalMem no implement");
	return NO_INIT;
}

status_t SurfaceMediaSource::transformExternalMem(unsigned int srcPA, unsigned int srcW,
...
{
	LOGE("SurfaceMediaSource::transformExternalMem no implement");
	return NO_INIT;
}
