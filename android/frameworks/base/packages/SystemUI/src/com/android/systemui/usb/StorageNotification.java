...
public class StorageNotification extends StorageEventListener {
    ...
    private void onUsbMassStorageConnectionChangedAsync(boolean connected) {
        ...
        mUmsPath =  Environment.getExternalStorageDirectory().getPath();
    ...
    private void onStorageStateChangedAsync(String path, String oldState, String newState) {
        ...
        if (newState.equals(Environment.MEDIA_SHARED)) {
             ...
             * UMS notification.
             */
            int titleId = com.android.internal.R.string.ext_media_checking_notification_title;
            if("/mnt/usbdisk".equals(path)) {
                    titleId = com.android.internal.R.string.ext_media_checking_notification_usb_title;
            }
	     ...
	     //LWC fix bug 3406
            if("/mnt/usbdisk".equals(path)) {
                 setMediaStorageNotification(
                       com.android.internal.R.string.ext_media_mounting_notification_usb_title,
                       com.android.internal.R.string.ext_media_mounting_notification_usb_message,
                       com.android.internal.R.drawable.stat_notify_sdcard_prepare, true, true, null);
            }else{
		 setMediaStorageNotification(
                        com.android.internal.R.string.ext_media_mounting_notification_title,
                        com.android.internal.R.string.ext_media_mounting_notification_message,
                        com.android.internal.R.drawable.stat_notify_sdcard_prepare, true, true, null);
            }
            ...
            if (!mStorageManager.isUsbMassStorageEnabled()) {
                if (oldState.equals(Environment.MEDIA_SHARED)) {
                    ...
                    if (Environment.isExternalStorageRemovable()) {
                        if("/mnt/usbdisk".equals(path)) {
                               setMediaStorageNotification(
                                    com.android.internal.R.string.ext_media_safe_unmount_notification_usb_title,
                                    com.android.internal.R.string.ext_media_safe_unmount_notification_usb_message,
            ...
            if("/mnt/usbdisk".equals(path)) {
                  setMediaStorageNotification(
                      com.android.internal.R.string.ext_media_nofs_notification_usb_title,
                      com.android.internal.R.string.ext_media_nofs_notification_usb_message,
            ...
            if("/mnt/usbdisk".equals(path)) {
                 setMediaStorageNotification(
                      com.android.internal.R.string.ext_media_unmountable_notification_usb_title,
                      com.android.internal.R.string.ext_media_unmountable_notification_usb_message,
                      com.android.internal.R.drawable.stat_notify_sdcard_usb, true, false, pi);
            }else{
                 setMediaStorageNotification(
            ...
            if("/mnt/usbdisk".equals(path)) {
                 setMediaStorageNotification(
                      com.android.internal.R.string.ext_media_nomedia_notification_usb_title,
                      com.android.internal.R.string.ext_media_nomedia_notification_usb_message,
            ...
            if("/mnt/usbdisk".equals(path)) {
                 setMediaStorageNotification(
                      com.android.internal.R.string.ext_media_badremoval_notification_usb_title,
                      com.android.internal.R.string.ext_media_badremoval_notification_usb_message,
    ...
    void updateUsbMassStorageNotification(boolean available) {
        ...
        if (available) {
	    if(!("/mnt/usbdisk".equals(mUmsPath))){
                Intent intent = new Intent();
                intent.setClass(mContext, com.android.systemui.usb.UsbStorageActivity.class);
