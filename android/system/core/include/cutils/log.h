...
#endif
#ifndef SDNULOGD
#define SDNULOGD(...) ((void)NULOG(LOG_DEBUG, LOG_TAG, SDLOG_OWNER, SDLOG_FILE, SDLOG_FUNC, SDLOG_LINE, __VA_ARGS__))
#endif

#ifndef SDNULOGE
#define SDNULOGE(...) ((void)NULOG(LOG_ERROR, LOG_TAG, SDLOG_OWNER, SDLOG_FILE, SDLOG_FUNC, SDLOG_LINE, __VA_ARGS__))
#endif
...
#endif
#ifndef ZXNULOGD
#define ZXNULOGD(...) ((void)NULOG(LOG_DEBUG, LOG_TAG, ZXLOG_OWNER, ZXLOG_FILE, ZXLOG_FUNC, ZXLOG_LINE, __VA_ARGS__))
#endif

#ifndef ZXLOGE
#define ZXLOGE(...) ((void)NULOG(LOG_ERROR, LOG_TAG, ZXLOG_OWNER, ZXLOG_FILE, ZXLOG_FUNC, ZXLOG_LINE, __VA_ARGS__))
#endif
...
*/
#ifndef NULOG
#define NULOG(priority, tag, owner, file_name, func_name, line_num, ...) \
    NULOG_PRI(ANDROID_##priority, tag, owner, file_name, func_name, line_num, __VA_ARGS__)
#endif

#ifndef NULOG_PRI
#define NULOG_PRI(priority, tag, owner, file_name, func_name, line_num, ...) \
    nufront_android_printLog(priority, tag, owner, file_name, func_name, line_num, __VA_ARGS__)
#endif
#define nufront_android_printLog(prio, tag, owner, file_name, func_name, line_num, fmt...) \
    __nufront_android_log_print(prio, tag, owner, file_name, func_name, line_num, fmt)
