...
public class SurfaceView extends View {
     ...
     */
    /* To enable dithering when display format=RGB565, force surface format=RGBA8888 on ns2816*/
    int mRequestedFormat = "ns2816".equals(SystemProperties.get("ro.board.platform"))
